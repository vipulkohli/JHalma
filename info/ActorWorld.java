...
{    
    ...
    public ActorWorld()
    {
     ...
     public ActorWorld(Grid<Actor> grid, int val)
    {
        super(grid);
        steps = 0;
        this.val = val;
    ...
    public void step()
    {
        try{
	        ...
	        if (called < 1 && gr.getOccupiedLocations().size() <= 1500){
	        	String mess = "" + val + ": " + steps + " " + gr.getOccupiedLocations().size() + "%";
	        	setMessage(mess);
